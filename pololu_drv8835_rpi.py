...
def io_init():
  ...
  wiringpi2.pinMode(24, wiringpi2.GPIO.PWM_OUTPUT)
  wiringpi2.pinMode(25, wiringpi2.GPIO.PWM_OUTPUT)

  wiringpi2.pwmSetMode(wiringpi2.GPIO.PWM_MODE_MS)
  wiringpi2.pwmSetRange(MAX_SPEED)
  wiringpi2.pwmSetClock(2)

  wiringpi2.pinMode(18, wiringpi2.GPIO.OUTPUT)
...
class Motors(object):
    ...
    def __init__(self):
        self.motor1 = Motor(24, 25)
        self.motor2 = Motor(18, 23)
